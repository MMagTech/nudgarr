...
- Sweep cards redesigned — lifetime Searched and Sweep Runs now shown below per-run stats; Disabled badge replaces full-card dim; last run moved to card header
